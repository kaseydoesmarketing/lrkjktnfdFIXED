      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="p-6">
              ...
              {!selectedTestForMomentum && (
                <div className="text-center py-8 text-gray-500">
                  ...
                  <p>Select an active test to see Claude AI insights</p>
                </div>
              )}
            </div>
          </div>
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-2xl font-bold text-gray-900">Your Title Tests</h2>
            <div className="flex items-center space-x-3">
              <button 
                onClick={() => setShowTitleSuggestions(!showTitleSuggestions)}
                className="bg-gradient-to-r from-yellow-600 to-orange-600 hover:from-yellow-700 hover:to-orange-700 text-white font-medium py-2 px-4 rounded-lg transition-all duration-200 flex items-center space-x-2"
              >
