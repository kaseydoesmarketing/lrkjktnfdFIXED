  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        {/* Stats Cards with Momentum Integration */}
        <div className="grid grid-cols-2 lg:grid-cols-5 gap-4 mb-8">
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
            ...
            <div>
              <p className="text-sm font-medium text-gray-600 mb-1">Test Streak</p>
              <p className="text-2xl font-bold text-gray-900">{momentum.currentStreak} days</p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
            ...
            <div>
              <p className="text-sm font-medium text-gray-600 mb-1">Optimizations</p>
              <p className="text-2xl font-bold text-gray-900">{momentum.totalOptimizations}</p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {/* Video Selection & Create Test (Takes up 2/3 of width) */}
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-xl border border-gray-200 shadow-sm">
              <div className="border-b border-gray-100 p-6">
                <div className="flex items-center justify-between">
                  <div>
                    <h3 className="text-lg font-bold text-gray-900">Video Library</h3>
                    <p className="text-gray-600 mt-1">Select a video to create an A/B test</p>
                  </div>
                  <Button
            ...
            <div className="bg-white rounded-xl border border-gray-200 shadow-sm">
              <div className="border-b border-gray-100 p-6">
                <div className="flex items-center justify-between">
                  <div>
                    <h3 className="text-lg font-bold text-gray-900">Active Tests</h3>
                    <p className="text-gray-600 mt-1">Monitor your running A/B tests</p>
                  </div>
                  <div className="flex items-center space-x-3">
